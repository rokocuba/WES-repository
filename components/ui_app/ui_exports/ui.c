...
static lv_img_dsc_t *ui_imgset_[] = {
    (lv_img_dsc_t *)&ui_img_bg16_png,
};
...
void ui_init(void)
{
    ...
    ui_Music_scr_screen_init();
    ui_Number_scr_screen_init();
    ui_Vlaga_scr_screen_init();
...
void ui_destroy(void)
{
    ...
    ui_Music_scr_screen_destroy();
    ui_Number_scr_screen_destroy();
    ui_Vlaga_scr_screen_destroy();
}
